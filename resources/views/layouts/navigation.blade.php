<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <a href="{{ route('dashboard') }}">
        <svg class="block h-10 w-auto fill-current text-blue-600" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
      <div class="pt-2 pb-3 space-y-1">
        ...
        <x-responsive-nav-link :href="route('alternatives.index')" :active="request()->routeIs('alternatives.*')">
            {{ __('Data Alternatif') }}
        </x-responsive-nav-link>
