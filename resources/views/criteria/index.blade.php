                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                            ...
                            <td class="border p-3 text-center">
                                <span class="{{ $c->attribute == 'benefit' ? 'text-green-600 bg-green-100' : 'text-red-600 bg-red-100' }} px-2 py-1 rounded text-xs font-bold uppercase tracking-wider">
                                    {{ $c->attribute }}
                                </span>
                            </td>
                            <td class="border p-3 text-center">
                ...
                <div x-show="showAddModal"
                    ...
                    <div class="p-6 text-left">
                        <form action="{{ route('criteria.store') }}" method="POST">
                            @csrf 
                            <div class="mb-4">
                                <label class="block mb-2 font-semibold text-sm text-gray-700">Nama Kriteria</label>
                            ...
                            <div class="mb-4">
                                <label class="block mb-2 font-semibold text-sm text-gray-700">Bobot (%)</label>
                                <input type="number" step="0.01" name="weight" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 transition" required>
                            </div>
                            <div class="mb-6">
                                <label class="block mb-2 font-semibold text-sm text-gray-700">Atribut</label>
                                <select name="attribute" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 transition">
                ...
                <div x-show="showEditModal"
                    ...
                    <div class="p-6 text-left">
                        <form :action="editData.action" method="POST">
                            ...
                            <div class="mb-4">
                                <label class="block mb-2 font-semibold text-sm text-gray-700">Bobot (%)</label>
                                <input type="number" step="0.01" name="weight" :value="editData.weight" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-yellow-500 focus:border-yellow-500 transition" required>
                            </div>
                            <div class="mb-6">
                                <label class="block mb-2 font-semibold text-sm text-gray-700">Atribut</label>
                                <select name="attribute" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-yellow-500 focus:border-yellow-500 transition" :value="editData.attribute">
                                    <option value="benefit">Benefit</option>
                                    <option value="cost">Cost</option>
                                </select>
                            </div>
