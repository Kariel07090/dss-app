                    ...
                    <div class="overflow-hidden border border-gray-200 rounded-lg">
                        <table class="w-full text-sm text-left text-gray-600">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                @forelse($paginatedRanks as $rank)
                                @php
                                    // LOGIKA BENAR: firstItem() + index loop
                                    // firstItem() mengembalikan nomor item pertama di halaman tersebut (misal: 11)
                                    $absoluteNumber = $paginatedRanks->firstItem() + $loop->index;
                                @endphp
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="font-medium">Belum ada hasil perankingan.</p>
                                            <p class="text-xs mt-1 text-gray-400">Pastikan data alternatif dan penilaian sudah diinput.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
                                ...
                                <tr>
                                    <td colspan="3" class="px-6 py-8 text-center text-gray-500">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-xs mt-1 text-gray-400">Silakan tambah data di menu "Data Alternatif".</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
